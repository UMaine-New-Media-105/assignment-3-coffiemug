...
if (boneY>=groundLevel && boneX>=mouseX-15 && boneX<=mouseX+50){
...
//this function is what changes around the puppy sprite, signalling that a bone was caught
...
function bone(x,y,size,angle){
  ...
  ellipse(16,35,10);
  ellipse(20,30,10);
  if(boneDropping==true){
   boneY=boneY+boneDropSpeed
  }
  //if(boneDropping==false){
    //bone(boneX,boneY,1,boneAngle)
